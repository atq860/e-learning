...
export const QUESTION_CLOSE_REQUEST = " QUESTION_CLOSE_REQUEST";
export const QUESTION_CLOSE_SUCCESS = " QUESTION_CLOSE_SUCCESS";
export const QUESTION_CLOSE_FAIL = " QUESTION_CLOSE_FAIL";
export const QUESTION_CLOSE_RESET = " QUESTION_CLOSE_RESET";
